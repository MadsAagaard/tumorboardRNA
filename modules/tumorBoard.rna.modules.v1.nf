...
process splicing_inhouse_list {
    ...
    script:
    """
    cat ${trinity_splicing} | grep -w -f ${inhouse_genelist} > ${caseID}.${sampleID}.trinity_splicing.INHOUSE.txt
    """
}
...
process arriba {
    ...
    publishDir "${caseID}/${params.outdir}/TumorTarget_files", mode: 'copy', pattern: "*.{INHOUSE.txt,pdf}"
    input:
    ...
    tuple val(caseID), path("${caseID}.${sampleID}.arriba.fusions.INHOUSE.txt"), emit: fusions
    ...
    cat ${caseID}.${sampleID}.arriba.fusions.txt| grep -w -f ${inhouse_genelist} > ${caseID}.${sampleID}.arriba.fusions.INHOUSE.txt
    """
}
...
process starfusion {
    ...
    tuple val(caseID), path("${caseID}.${sampleID}.StarFusion.INHOUSE.txt"), emit: fusions 
    ...
    cat ${caseID}.${sampleID}_abridged.tsv | grep -w -f /data/shared/genomes/databases/genelists/tumortarget/tumortarget.inhouse.v2.127genes.txt > ${caseID}.${sampleID}.StarFusion.INHOUSE.txt
    """
}
...
process kallisto_pizzly {
    ...
    output:
    tuple val(caseID), path("${caseID}_${sampleID}.pizzlyFusions.INHOUSE.txt"), emit: fusions
    ...
    cat ${caseID}_${sampleID}.pizzlyFusions.txt | grep -w -f ${inhouse_genelist} > ${caseID}_${sampleID}_pizzlyFusions.INHOUSE.txt
    """
}
*/
process kallisto_pizzly {
    ...
    cat !{caseID}_!{sampleID}.pizzlyFusions.txt | grep -w -f !{inhouse_genelist} > !{caseID}_!{sampleID}.pizzlyFusions.INHOUSE.txt
    '''
}
...
process jaffa_conda {
    ...
    output:
    tuple val(caseID), path("${caseID}.jaffaFusions.INHOUSE.csv"), emit: fusions
    ...
    cat ${caseID}.jaffaFusions.csv | grep -w -f ${inhouse_genelist} > ${caseID}.jaffaFusions.INHOUSE.csv
    """
}
...
process fusioncatcher {
    ...
    output:
    path("fusioncatcher/")
    tuple val(caseID), path("fusioncatcher/${caseID}.${sampleID}.fusioncatcher.fusions.INHOUSE.txt"), emit: fusions
    ...
    cat fusioncatcher/${caseID}.${sampleID}.fusioncatcher.fusions.txt | grep -w -f ${inhouse_genelist} > fusioncatcher/${caseID}.${sampleID}.fusioncatcher.fusions.INHOUSE.txt
    """
}
...
process fusionreport_inhouse {
    ...
    publishDir "${caseID}/${params.outdir}/genefusions/fusionReportINHOUSE/", mode: 'copy'
    ...
    path("${caseID}.FusionReport.INHOUSE.html")
    script:
    """
    ...
    mv fusionreport_output/index.html fusionreport_output/${caseID}.FusionReport.INHOUSE.html
    cp fusionreport_output/${caseID}.FusionReport.INHOUSE.html .
    """
    //
    //    --jaffa ${jaffa_fusions}
}
...
process fusion_inspector { 
    ...
    publishDir "${caseID}/${params.outdir}/TumorTarget_files", mode: 'copy', pattern: "${caseID}.${sampleID}.Finspector/* /*.INHOUSE.*"
    ...
    cat ${caseID}.${sampleID}.Finspector/${caseID}.${sampleID}.FusionInspector.fusions.abridged.tsv| grep -w -f ${inhouse_genelist} > ${caseID}.${sampleID}.Finspector/${caseID}.${sampleID}.fusionInspector.INHOUSE.txt
    """
}
