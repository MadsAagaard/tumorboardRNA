...
if (params.fastq) {
    params.reads="${params.fastq}/**{.,-}{RV1,RV1_NGC}{.,-}*R{1,2}*{fq.gz,fastq,fastq.gz}"
...
if (!params.fastq) {
    params.reads="${data_archive}/{lnx02,tank_kga_external_archive}/**/*{.,-}{RV1,RV1_NGC}{.,-}*R{1,2}*{fq,fastq}.gz"
